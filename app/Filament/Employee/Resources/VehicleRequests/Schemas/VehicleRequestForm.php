...
class VehicleRequestForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                Wizard::make([
                    Step::make('Schedule & Purpose')
                        ->description('Travel dates, time, and purpose of trip')
                    ...
                    Step::make('Destination Address')
                        ->description('Where the university vehicle will travel')
