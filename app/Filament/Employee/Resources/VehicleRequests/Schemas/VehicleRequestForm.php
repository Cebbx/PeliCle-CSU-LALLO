        ...
        return $schema
            ->components([
                Section::make('Requester Information')
                    ->description('Details of the employee requesting the university vehicle')
                ...
                Section::make('Travel Details & Destination')
                    ->description('Specify where you are traveling, travel purpose, and travel dates')
                ...
                Section::make('Passenger Manifest')
                    ->description('List of authorized passengers joining this trip')
                            ...
                            Grid::make(1)
                                ...
                                ->schema([
                                    TextInput::make('number_of_passengers')
                                        ...
                                        ->dehydrated()
                                        ->required()
                                        ->helperText('Automatically computed from the passenger list.'),
