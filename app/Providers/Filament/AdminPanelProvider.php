...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->brandLogo(new \Illuminate\Support\HtmlString('<div class="brand-logo-wrapper" style="display: flex; align-items: center; gap: 8px; background: transparent !important;"><div style="width: 26px; height: 26px; border-radius: 6px; background: rgba(255, 255, 255, 0.08); border: 1px solid rgba(255, 255, 255, 0.12); display: flex; align-items: center; justify-content: center; overflow: hidden; flex-shrink: 0;"><img src="' . asset('csu-logo.png') . '" style="height: 20px; width: auto; object-fit: contain;" /></div><span class="brand-title-text font-bold text-base tracking-wider" style="font-family: \'Outfit\', sans-serif;">PeliCle</span><style>.fi-simple-layout .brand-title-text { display: none !important; } .fi-simple-layout .brand-logo-wrapper { justify-content: center !important; gap: 0 !important; } .fi-simple-layout img { height: 3.2rem !important; } html.dark .brand-title-text { color: #ffffff !important; } html:not(.dark) .brand-title-text { color: #0f172a !important; } .fi-logo, a.fi-logo, .brand-logo-wrapper { background: transparent !important; background-color: transparent !important; box-shadow: none !important; border: none !important; }</style></div>'))
