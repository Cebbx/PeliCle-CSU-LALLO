    ...
    <div class="dashboard-wrapper">
        ...
        <div class="row-grid-4">
            ...
            <div class="dash-card">
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 45" class="card-wave-svg" preserveAspectRatio="none">
            ...
            <div class="dash-card">
                <div class="card-top-row">
                    <div class="card-badge-wrap">
                        <div class="card-icon-round bg-icon-green">
                            <svg style="width: 15px; height: 15px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
        ...
        <div class="row-grid-3">
            ...
            <div class="dash-card" style="padding-bottom: 0;">
                <div class="card-top-row">
                    <div class="card-badge-wrap">
                        <div class="card-icon-round bg-icon-blue" style="font-weight: 800; font-size: 13px;">A</div>
            ...
            <div class="dash-card" style="padding-bottom: 16px;">
                <div class="card-top-row">
                    <div class="card-badge-wrap">
                ...
                <!-- Smooth Amber Wave -->
                <div style="margin: 8px -16px -16px -16px; height: 20px; overflow: hidden;">
            ...
            <div class="dash-card" style="padding-bottom: 16px;">
                ...
                <div style="width: 100%; height: 3px; background: rgba(239, 68, 68, 0.2); border-radius: 99px; margin-top: 12px; overflow: hidden;">
        ...
        <div class="row-grid-bottom">
            ...
            <div class="dash-card dash-card-pad">
                ...
                <div style="position: relative; width: 100%; height: 140px; display: flex; flex-direction: column; justify-content: space-between;">
                    ...
                    <div style="position: relative; width: 100%; height: 110px;">
                        <svg viewBox="0 0 350 140" style="width: 100%; height: 100%; display: block;" preserveAspectRatio="none">
                            <defs>
                                <linearGradient id="chartAreaGradientHD2" x1="0" y1="0" x2="0" y2="1">
                            ...
                            <!-- Area Gradient Fill -->
                            <path d="M 0,130 Q 30,110 60,95 T 120,25 T 175,35 T 235,75 T 295,95 T 350,130 L 350,140 L 0,140 Z" fill="url(#chartAreaGradientHD2)" />
                    ...
                    <!-- Day Labels -->
                    <div style="display: flex; justify-content: space-between; font-size: 10.5px; color: #94a3b8; padding-top: 2px;">
                        <span>Mon</span>
                        <span>Tue</span>
                        <span>Wed</span>
                        <span>Thu</span>
                ...
                <div style="display: flex; align-items: center; justify-content: center; gap: 5px; font-size: 10.5px; color: #94a3b8; margin-top: 6px;">
            ...
            <div class="dash-card dash-card-pad">
                ...
                <!-- Donut Chart & Legend -->
                <div style="display: flex; align-items: center; justify-content: space-between; gap: 14px; margin: auto 0;">
                    
                    <!-- Fixed SVG Donut Ring -->
                    <div style="position: relative; width: 115px; height: 115px; flex-shrink: 0; display: flex; align-items: center; justify-content: center;">
                        <svg viewBox="0 0 100 100" style="width: 115px; height: 115px; transform: rotate(-90deg); display: block;">
                            <!-- Background Track -->
                        ...
                        <div style="position: absolute; text-align: center; pointer-events: none;">
                            ...
                            <div style="font-size: 20px; font-weight: 800; color: #ffffff; line-height: 1.1;">
                    ...
                    <!-- Legend -->
                    <div style="display: flex; flex-direction: column; gap: 7px; flex-grow: 1; font-size: 10.5px;">
