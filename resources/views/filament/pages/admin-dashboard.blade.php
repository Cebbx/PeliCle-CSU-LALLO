<x-filament-panels::page>
    <style>
        /* Zero-Scroll Ultra-Fit Layout (1366x768 & HD Screens) */
        .fi-page {
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="row-grid-4">
            ...
            <div class="dash-card">
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 40" class="card-wave-svg" preserveAspectRatio="none">
                        <path d="M0,35 C70,32 120,6 180,10 C240,14 270,30 300,35" fill="none" stroke="#10b981" stroke-width="2.2" />
                    </svg>
                </div>
            </div>
            ...
            <div class="dash-card">
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 40" class="card-wave-svg" preserveAspectRatio="none">
                        <path d="M0,32 C60,35 120,4 180,11 C240,18 270,6 300,4" fill="none" stroke="#10b981" stroke-width="2.2" />
                    </svg>
                </div>
            </div>
            ...
            <div class="dash-card">
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 40" class="card-wave-svg" preserveAspectRatio="none">
                        <path d="M0,35 C80,30 160,16 220,20 C260,24 280,32 300,35" fill="none" stroke="#475569" stroke-width="2" />
                    </svg>
                </div>
            </div>
            ...
            <div class="dash-card">
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 40" class="card-wave-svg" preserveAspectRatio="none">
                        <path d="M0,35 C70,25 120,4 180,8 C240,12 270,30 300,35" fill="none" stroke="#10b981" stroke-width="2.2" />
                    </svg>
                </div>
            </div>
        ...
        <div class="row-grid-3">
            ...
            <div class="dash-card">
                <div class="card-top-row">
                    <div class="card-badge-wrap">
                        <div class="card-icon-round bg-icon-blue" style="font-weight: 800; font-size: 12px;">A</div>
                ...
                <div class="card-wave-box">
                    <svg viewBox="0 0 300 40" class="card-wave-svg" preserveAspectRatio="none">
                        <path d="M0,35 C80,32 140,12 200,18 C260,24 280,35 300,35" fill="none" stroke="#0284c7" stroke-width="2.2" />
                    </svg>
                </div>
            </div>

            <!-- 2. Pending Withdrawal Slips -->
            <div class="dash-card" style="padding-bottom: 10px;">
                <div class="card-top-row">
                    <div class="card-badge-wrap">
                ...
                <!-- Smooth Amber Wave -->
                <div style="margin: 4px -14px -10px -14px; height: 16px; overflow: hidden;">
                    <svg viewBox="0 0 300 20" style="width: 100%; height: 100%;" preserveAspectRatio="none">
                        <path d="M0,17 C80,15 160,5 240,8 L300,3" fill="none" stroke="#f59e0b" stroke-width="2" />
                    </svg>
                </div>
            </div>
            ...
            <div class="dash-card" style="padding-bottom: 10px;">
                ...
                <div style="width: 100%; height: 2.5px; background: rgba(239, 68, 68, 0.2); border-radius: 99px; margin-top: 8px; overflow: hidden;">
        ...
        <!-- ROW 3: Three Visual Analytics & Recent Activity Cards (Fills Remaining Space) -->
        <div class="row-grid-bottom">
            ...
            <div class="dash-card dash-card-pad">
                ...
                <div style="position: relative; width: 100%; height: calc(100% - 46px); display: flex; flex-direction: column; justify-content: space-between;">
                    ...
                    <div style="position: relative; width: 100%; height: calc(100% - 24px);">
                        <svg viewBox="0 0 350 140" style="width: 100%; height: 100%; display: block;" preserveAspectRatio="none">
                            ...
                            <circle cx="120" cy="25" r="4" fill="#ffffff" stroke="#0284c7" stroke-width="2.2" />
                            <circle cx="175" cy="35" r="4" fill="#ffffff" stroke="#0284c7" stroke-width="2.2" />
                ...
                <div style="display: flex; align-items: center; justify-content: center; gap: 5px; font-size: 10px; color: #94a3b8; margin-top: 4px; flex-shrink: 0;">
            ...
            <div class="dash-card dash-card-pad">
                ...
                <!-- Donut Chart & Legend -->
                <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px; margin: auto 0; flex-grow: 1;">
                    ...
                    <div style="position: relative; width: 100px; height: 100px; flex-shrink: 0; display: flex; align-items: center; justify-content: center;">
                        <svg viewBox="0 0 100 100" style="width: 100px; height: 100px; transform: rotate(-90deg); display: block;">
                            <!-- Background Track -->
                    ...
                    <!-- Legend -->
                    <div style="display: flex; flex-direction: column; gap: 6px; flex-grow: 1; font-size: 10px;">
            ...
            <div class="dash-card dash-card-pad">
                ...
                <div class="feed-list-box">
                    ...
                    @empty
                        <div style="padding: 20px 0; text-align: center; color: #64748b; font-size: 11px;">
